  ...
  render() {
    return (
      ...
      >
        ...
        <div className='absolute top-1 left-8 w-fit h-fit flex'>
          <div className='relative mr-0 bg-transparent rounded-md p-1 bg-slate-700 flex justify-between items-center'>
            <div className='border border-dashed border-slate-600 py-2 px-4 rounded-md'>
              <button
              ...
              >
                <svg viewBox='0 0 30.143 30.143' className='w-3'>
                  <g>
                    <path
                      fill='#030104'
              ...
              {this.state.power ? (
                <span
                  className='rounded-full inline-block ml-4 mr-1 w-[0.8em] h-[0.8em] bg-green-400'
                  style={{ boxShadow: '0 0 0.6em 0.2em rgb(134, 239, 172)' }}
                ></span>
              ) : (
                <span
                  className='rounded-full inline-block ml-4 mr-1 w-[0.8em] h-[0.8em] bg-red-400'
